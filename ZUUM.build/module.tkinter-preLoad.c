...
static void createModuleConstants(void) {
    const_str_digest_30726611e59fa5fa6b5721deb8c88bbb = UNSTREAM_STRING_ASCII(&constant_bin[ 8135 ], 24, 0);
    const_tuple_str_plain_TCL_LIBRARY_none_tuple = PyTuple_New(2);
    const_str_plain_TCL_LIBRARY = UNSTREAM_STRING_ASCII(&constant_bin[ 8159 ], 11, 1);
    ...
    const_str_digest_0492865e46cd96ee17148a12c234a543 = UNSTREAM_STRING_ASCII(&constant_bin[ 8170 ], 19, 0);
    const_str_plain_tk = UNSTREAM_STRING_ASCII(&constant_bin[ 1387 ], 2, 1);
    const_str_plain_tcl = UNSTREAM_STRING_ASCII(&constant_bin[ 5758 ], 3, 1);
    const_str_plain_TK_LIBRARY = UNSTREAM_STRING_ASCII(&constant_bin[ 8189 ], 10, 1);
    const_str_plain___nuitka_binary_dir = UNSTREAM_STRING_ASCII(&constant_bin[ 2000 ], 19, 1);
...
PyObject *modulecode_tkinter$$45$preLoad(PyObject *module) {
...
// Mark the execution in the "__spec__" value.
    ...
    branch_yes_1:;
    {
        ...
        if (tmp_mvar_value_5 == NULL) {
            ...
            exception_type = PyExc_NameError;
            Py_INCREF(exception_type);
            exception_value = UNSTREAM_STRING(&constant_bin[ 1994 ], 41, 0);
            exception_tb = NULL;
            NORMALIZE_EXCEPTION(&exception_type, &exception_value, &exception_tb);
            CHAIN_EXCEPTION(exception_value);
        ...
        tmp_ass_subscribed_1 = LOOKUP_ATTRIBUTE(tmp_expression_name_4, const_str_plain_environ);
    ...
    }
    {
        ...
        tmp_called_name_2 = LOOKUP_ATTRIBUTE(tmp_expression_name_5, const_str_plain_join);
        ...
        tmp_ass_subscribed_2 = LOOKUP_ATTRIBUTE(tmp_expression_name_7, const_str_plain_environ);
