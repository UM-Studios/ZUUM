...
static void _createGlobalConstants(void) {
    ...
    const_float_0_0 = UNSTREAM_FLOAT(&constant_bin[ 16646 ]);
    const_float_1_0 = UNSTREAM_FLOAT(&constant_bin[ 16654 ]);
    ...
    const_str_plain_rb = UNSTREAM_STRING_ASCII(&constant_bin[ 16662 ], 2, 1);
    ...
    const_str_plain_now = UNSTREAM_STRING_ASCII(&constant_bin[ 16664 ], 3, 1);
    const_str_plain_sum = UNSTREAM_STRING_ASCII(&constant_bin[ 16667 ], 3, 1);
    ...
    const_str_plain_iter = UNSTREAM_STRING_ASCII(&constant_bin[ 16670 ], 4, 1);
    const_str_plain_join = UNSTREAM_STRING_ASCII(&constant_bin[ 2073 ], 4, 1);
    const_str_plain_keys = UNSTREAM_STRING_ASCII(&constant_bin[ 16674 ], 4, 1);
    ...
    const_str_plain_read = UNSTREAM_STRING_ASCII(&constant_bin[ 7435 ], 4, 1);
    const_str_plain_repr = UNSTREAM_STRING_ASCII(&constant_bin[ 16678 ], 4, 1);
    const_str_plain_self = UNSTREAM_STRING_ASCII(&constant_bin[ 16682 ], 4, 1);
    const_str_plain_send = UNSTREAM_STRING_ASCII(&constant_bin[ 16686 ], 4, 1);
    ...
    const_float_minus_0_0 = UNSTREAM_FLOAT(&constant_bin[ 16690 ]);
    const_float_minus_1_0 = UNSTREAM_FLOAT(&constant_bin[ 16698 ]);
    const_str_plain_False = UNSTREAM_STRING_ASCII(&constant_bin[ 16706 ], 5, 1);
    const_str_plain_bytes = UNSTREAM_STRING_ASCII(&constant_bin[ 16711 ], 5, 1);
    const_str_plain_close = UNSTREAM_STRING_ASCII(&constant_bin[ 3516 ], 5, 1);
    const_str_plain_items = UNSTREAM_STRING_ASCII(&constant_bin[ 16716 ], 5, 1);
    const_str_plain_level = UNSTREAM_STRING_ASCII(&constant_bin[ 456 ], 5, 1);
    const_str_plain_match = UNSTREAM_STRING_ASCII(&constant_bin[ 16721 ], 5, 1);
    const_str_plain_print = UNSTREAM_STRING_ASCII(&constant_bin[ 16726 ], 5, 1);
    const_str_plain_range = UNSTREAM_STRING_ASCII(&constant_bin[ 549 ], 5, 1);
    const_str_plain_split = UNSTREAM_STRING_ASCII(&constant_bin[ 16731 ], 5, 1);
    const_str_plain_throw = UNSTREAM_STRING_ASCII(&constant_bin[ 16736 ], 5, 1);
    const_str_plain_tuple = UNSTREAM_STRING_ASCII(&constant_bin[ 16741 ], 5, 1);
    const_str_plain_types = UNSTREAM_STRING_ASCII(&constant_bin[ 16746 ], 5, 1);
    const_str_angle_lambda = UNSTREAM_STRING_ASCII(&constant_bin[ 6176 ], 8, 0);
    const_str_plain_Friday = UNSTREAM_STRING_ASCII(&constant_bin[ 16751 ], 6, 1);
    const_str_plain_Monday = UNSTREAM_STRING_ASCII(&constant_bin[ 16757 ], 6, 1);
    const_str_plain_Sunday = UNSTREAM_STRING_ASCII(&constant_bin[ 16763 ], 6, 1);
    const_str_plain_append = UNSTREAM_STRING_ASCII(&constant_bin[ 16769 ], 6, 1);
    ...
    const_str_plain_origin = UNSTREAM_STRING_ASCII(&constant_bin[ 16775 ], 6, 1);
    const_str_plain_remove = UNSTREAM_STRING_ASCII(&constant_bin[ 16781 ], 6, 1);
    const_str_plain_Trigger = UNSTREAM_STRING_ASCII(&constant_bin[ 210 ], 7, 1);
    const_str_plain_Tuesday = UNSTREAM_STRING_ASCII(&constant_bin[ 16787 ], 7, 1);
    const_str_plain___all__ = UNSTREAM_STRING_ASCII(&constant_bin[ 16794 ], 7, 1);
    const_str_plain___cmp__ = UNSTREAM_STRING_ASCII(&constant_bin[ 16801 ], 7, 1);
    const_str_plain___doc__ = UNSTREAM_STRING_ASCII(&constant_bin[ 16808 ], 7, 1);
    const_str_plain_compile = UNSTREAM_STRING_ASCII(&constant_bin[ 16815 ], 7, 1);
    const_str_plain_environ = UNSTREAM_STRING_ASCII(&constant_bin[ 16822 ], 7, 1);
    const_str_plain_getattr = UNSTREAM_STRING_ASCII(&constant_bin[ 16829 ], 7, 1);
    const_str_plain_globals = UNSTREAM_STRING_ASCII(&constant_bin[ 16836 ], 7, 1);
    const_str_plain_inspect = UNSTREAM_STRING_ASCII(&constant_bin[ 16843 ], 7, 1);
    const_str_plain_install = UNSTREAM_STRING_ASCII(&constant_bin[ 7849 ], 7, 1);
    ...
    const_str_angle_listcomp = UNSTREAM_STRING_ASCII(&constant_bin[ 16850 ], 10, 0);
    const_str_plain_Saturday = UNSTREAM_STRING_ASCII(&constant_bin[ 16860 ], 8, 1);
    const_str_plain_Thursday = UNSTREAM_STRING_ASCII(&constant_bin[ 16868 ], 8, 1);
    const_str_plain___dict__ = UNSTREAM_STRING_ASCII(&constant_bin[ 16876 ], 8, 1);
    const_str_plain___exit__ = UNSTREAM_STRING_ASCII(&constant_bin[ 16884 ], 8, 1);
    ...
    const_str_plain___iter__ = UNSTREAM_STRING_ASCII(&constant_bin[ 16892 ], 8, 1);
    const_str_plain___main__ = UNSTREAM_STRING_ASCII(&constant_bin[ 16900 ], 8, 1);
    const_str_plain___name__ = UNSTREAM_STRING_ASCII(&constant_bin[ 16908 ], 8, 1);
    const_str_plain___path__ = UNSTREAM_STRING_ASCII(&constant_bin[ 16916 ], 8, 1);
    const_str_plain___spec__ = UNSTREAM_STRING_ASCII(&constant_bin[ 16924 ], 8, 1);
    const_str_plain_datetime = UNSTREAM_STRING_ASCII(&constant_bin[ 95 ], 8, 1);
    const_str_plain_filename = UNSTREAM_STRING_ASCII(&constant_bin[ 16932 ], 8, 1);
    const_str_plain_fromlist = UNSTREAM_STRING_ASCII(&constant_bin[ 16940 ], 8, 1);
    ...
    const_str_plain_taskname = UNSTREAM_STRING_ASCII(&constant_bin[ 16948 ], 8, 1);
    ...
    const_str_angle_metaclass = UNSTREAM_STRING_ASCII(&constant_bin[ 16956 ], 11, 0);
    const_str_plain_Wednesday = UNSTREAM_STRING_ASCII(&constant_bin[ 16967 ], 9, 1);
    const_str_plain___class__ = UNSTREAM_STRING_ASCII(&constant_bin[ 16976 ], 9, 1);
    const_str_plain___enter__ = UNSTREAM_STRING_ASCII(&constant_bin[ 16985 ], 9, 1);
    const_str_plain_build_XML = UNSTREAM_STRING_ASCII(&constant_bin[ 1214 ], 9, 1);
    const_str_plain_bytearray = UNSTREAM_STRING_ASCII(&constant_bin[ 16994 ], 9, 1);
    const_str_plain_metaclass = UNSTREAM_STRING_ASCII(&constant_bin[ 16957 ], 9, 1);
    const_str_plain_write_XML = UNSTREAM_STRING_ASCII(&constant_bin[ 1183 ], 9, 1);
    const_str_plain___cached__ = UNSTREAM_STRING_ASCII(&constant_bin[ 17003 ], 10, 1);
    const_str_plain___import__ = UNSTREAM_STRING_ASCII(&constant_bin[ 17013 ], 10, 1);
    const_str_plain___loader__ = UNSTREAM_STRING_ASCII(&constant_bin[ 17023 ], 10, 1);
    const_str_plain___module__ = UNSTREAM_STRING_ASCII(&constant_bin[ 17033 ], 10, 1);
    const_str_plain_startswith = UNSTREAM_STRING_ASCII(&constant_bin[ 17043 ], 10, 1);
    const_str_plain___getitem__ = UNSTREAM_STRING_ASCII(&constant_bin[ 17053 ], 11, 1);
    const_str_plain___package__ = UNSTREAM_STRING_ASCII(&constant_bin[ 17064 ], 11, 1);
    const_str_plain___prepare__ = UNSTREAM_STRING_ASCII(&constant_bin[ 17075 ], 11, 1);
    const_str_plain_classmethod = UNSTREAM_STRING_ASCII(&constant_bin[ 17086 ], 11, 1);
    const_str_plain_delete_task = UNSTREAM_STRING_ASCII(&constant_bin[ 839 ], 11, 1);
    const_str_plain___builtins__ = UNSTREAM_STRING_ASCII(&constant_bin[ 17097 ], 12, 1);
    const_str_plain___compiled__ = UNSTREAM_STRING_ASCII(&constant_bin[ 17109 ], 12, 1);
    const_str_plain___qualname__ = UNSTREAM_STRING_ASCII(&constant_bin[ 17121 ], 12, 1);
    const_str_plain_has_location = UNSTREAM_STRING_ASCII(&constant_bin[ 17133 ], 12, 1);
    const_str_plain_staticmethod = UNSTREAM_STRING_ASCII(&constant_bin[ 17145 ], 12, 1);
    const_str_plain_TaskFunctions = UNSTREAM_STRING_ASCII(&constant_bin[ 2888 ], 13, 1);
    const_str_plain___metaclass__ = UNSTREAM_STRING_ASCII(&constant_bin[ 17157 ], 13, 1);
    const_str_plain__initializing = UNSTREAM_STRING_ASCII(&constant_bin[ 17170 ], 13, 1);
    ...
    const_str_plain___mro_entries__ = UNSTREAM_STRING_ASCII(&constant_bin[ 17183 ], 15, 1);
    ...
    const_str_plain___class_getitem__ = UNSTREAM_STRING_ASCII(&constant_bin[ 17198 ], 17, 1);
    ...
    const_str_plain_submodule_search_locations = UNSTREAM_STRING_ASCII(&constant_bin[ 17215 ], 26, 1);
    const_str_digest_1e80d3180a55df67723460f9d681041e = UNSTREAM_STRING_ASCII(&constant_bin[ 17241 ], 27, 0);
    const_str_digest_25731c733fd74e8333aa29126ce85686 = UNSTREAM_STRING_ASCII(&constant_bin[ 2376 ], 2, 0);
    const_str_digest_3c5ea704501052d09946a50239597ecd = UNSTREAM_STRING_ASCII(&constant_bin[ 17268 ], 64, 0);
    const_str_digest_45e4dde2057b0bf276d6a84f4c917d27 = UNSTREAM_STRING_ASCII(&constant_bin[ 17332 ], 7, 0);
    const_str_digest_6a06ccac232ea7b3d934a58f271f7a47 = UNSTREAM_STRING_ASCII(&constant_bin[ 17268 ], 53, 0);
    const_str_digest_75fd71b1edada749c2ef7ac810062295 = UNSTREAM_STRING_ASCII(&constant_bin[ 17339 ], 46, 0);
    const_str_digest_9816e8d1552296af90d250823c964059 = UNSTREAM_STRING_ASCII(&constant_bin[ 17385 ], 46, 0);
    const_str_digest_adc474dd61fbd736d69c1bac5d9712e0 = UNSTREAM_STRING_ASCII(&constant_bin[ 17431 ], 47, 0);
    const_str_digest_fdd1f239b4f3ffd6efcccf00e4a637e0 = UNSTREAM_STRING_ASCII(&constant_bin[ 17478 ], 48, 0);
