...
static void createModuleConstants(void) {
    const_str_digest_30726611e59fa5fa6b5721deb8c88bbb = UNSTREAM_STRING_ASCII(&constant_bin[ 8146 ], 24, 0);
    const_tuple_str_plain_TCL_LIBRARY_none_tuple = PyTuple_New(2);
    const_str_plain_TCL_LIBRARY = UNSTREAM_STRING_ASCII(&constant_bin[ 8170 ], 11, 1);
    ...
    const_str_digest_0492865e46cd96ee17148a12c234a543 = UNSTREAM_STRING_ASCII(&constant_bin[ 8181 ], 19, 0);
    ...
    const_str_plain_TK_LIBRARY = UNSTREAM_STRING_ASCII(&constant_bin[ 8200 ], 10, 1);
